...
<!-- Pace style -->
<link rel="stylesheet" href="<%= request.getContextPath() %>/resources/plugins/pace/pace.min.css">
  <!-- Google Font -->
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="../login/logout.jsp" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
          	<li><a href="../examples/chosun.jsp"><i class="fa fa-circle-o"></i> 조선일보</a></li>
          	<li><a href="../examples/donga.jsp"><i class="fa fa-circle-o"></i> 동아일보</a></li>
